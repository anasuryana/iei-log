...
export default function ICT({ userInfo }) {
    ...
    function handleClickExport(fileType) {
        ...
        if (confirm('Are you sure want to export the data ?')) {
            axios({
                url: import.meta.env.VITE_APP_ENDPOINT + '/ict/trace-to-spreadsheet?' + params + '&file_type=' + fileType,
                method: 'GET',
                responseType: 'blob',
                headers: {
                    Authorization: 'Bearer ' + localStorage.getItem('token')
                ...
                saveAs(response.data, 'ICT Logs ' + Date.now() + ' .' + fileType)
            }).catch(error => {
                setIsExporting(false)
            })
        }
                        ...
                        <table className="table align-middle table-sm table-bordered table-hover">
                            <thead className="text-center table-dark">
                                <tr className="first">
                                    ...
                                    <th className="align-middle">Production Control No</th>
                                    ...
                                    <th className="align-middle">ICT No</th>
